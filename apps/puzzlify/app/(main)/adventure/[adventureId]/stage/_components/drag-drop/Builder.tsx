...
const initialPuzzles: Puzzle[] = [
  ...
  { id: "4", trackGroupId: "2", trackId: "1", name: "Puzzle 4" },
  { id: "5", trackGroupId: "2", trackId: "1", name: "Puzzle 5" },
  { id: "6", trackGroupId: "2", trackId: "1", name: "Puzzle 6" },
  ...
  { id: "10", trackGroupId: "2", trackId: "2", name: "Puzzle 10" },
  { id: "11", trackGroupId: "2", trackId: "2", name: "Puzzle 11" },
  { id: "12", trackGroupId: "2", trackId: "2", name: "Puzzle 12" },
  { id: "13", trackGroupId: "1", trackId: "3", name: "Puzzle 13" },
  { id: "14", trackGroupId: "1", trackId: "3", name: "Puzzle 14" },
  { id: "15", trackGroupId: "2", trackId: "3", name: "Puzzle 15" },
  { id: "16", trackGroupId: "2", trackId: "3", name: "Puzzle 16" },
...
const initialTrackGroups = [
  { id: "1", name: "Track Group 1", tracks: initialTracks },
  {
    id: "2",
    name: "Track Group 2",
    tracks: initialTracks.filter(({ id }) => id !== "4"),
  },
];
...
const Builder: React.FC = () => {
  ...
  const addTrackGroup = () => {
    setTrackGroups((prevTrackGroups) => [
      ...prevTrackGroups,
      {
        id: `${prevTrackGroups.length + 1}`,
        name: `Track Group ${prevTrackGroups.length + 1}`,
        tracks: initialTracks, // You can modify this if needed
      },
    ]);
  };
  ...
  return (
    <div className="flex w-full h-full">
      <div className="flex-1 grid gap-4 grid-rows-[auto_1fr] p-8">
        ...
        <HorizontalDivider onPress={addTrackGroup} />
        <div className="col-span-full rounded-md text-center">
          <div className={"p-2 border rounded-md shadow-sm overflow-auto"}>
            <Finish
              setPuzzles={setPuzzles}
