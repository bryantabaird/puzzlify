          ...
          return (
            <ListBoxItem
              className={(props) => {
                ...
                return "flex focus:outline-2 focus:outline-primary items-center cursor-move p-1 xl:p-2 text-sm rounded-md my-1 relative group border hover:bg-accent transition-colors";
              }}
            >
